                ...
                className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            id="name" autoComplete="name" required placeholder="Anas Moner" className="text-field" />
                        </div>
                      ...
                      <div className="mb-4">
                          ...
                          <input type="email" name="email"
                              id="email" autoComplete="email" required placeholder="anasmoner@gmail.com" className="text-field" />
                      </div>
                    </div>
